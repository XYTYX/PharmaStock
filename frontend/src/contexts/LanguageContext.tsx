...
const translations = {
  ...
  fr: {
    ...
    'dashboard.totalStockDesc': 'Unités en stock',
    'dashboard.recentMovementsTitle': 'Mouvements récents',
    ...
    'inventory.error': 'Erreur lors du chargement des données d\'inventaire',
    'inventory.totalItems': 'Articles totaux',
    'inventory.totalStock': 'Stock total',
    'inventory.recentMovements': 'Mouvements récents',
    ...
    'inventory.startDate': 'Date de début',
    ...
    'inventory.notes': 'Notes',
    'inventory.noMovements': 'Aucun mouvement d\'inventaire trouvé avec les critères sélectionnés',
    'inventory.purchase': 'Achat',
    'inventory.dispensation': 'Dispensation',
    'inventory.adjustment': 'Ajustement',
    'inventory.transfer': 'Transfert',
    'inventory.expired': 'Expiré',
    'inventory.damaged': 'Endommagé',
    ...
    'dispensation.error': 'Erreur lors du chargement des données de dispensation',
    ...
    'dispensation.dateFrom': 'Date de début',
    'dispensation.dateTo': 'Date de fin',
    'dispensation.date': 'Date',
    'dispensation.item': 'Article',
    'dispensation.type': 'Type',
    'dispensation.quantity': 'Quantité',
    'dispensation.user': 'Utilisateur',
    'dispensation.notes': 'Notes',
    'dispensation.noMovements': 'Aucun mouvement de dispensation trouvé avec les critères sélectionnés',
    ...
    'users.comingSoon': 'Gestion des utilisateurs bientôt disponible...',
    ...
    'users.errorUpdating': 'Erreur lors de la mise à jour de l\'utilisateur',
    'users.errorCreating': 'Erreur lors de la création de l\'utilisateur',
    ...
    'users.noPermission': 'Vous n\'avez pas la permission d\'accéder à cette page.',
    'users.userCreatedSuccess': 'Utilisateur créé avec succès',
    'users.userUpdatedSuccess': 'Utilisateur mis à jour avec succès',
    'users.userDeletedSuccess': 'Utilisateur supprimé avec succès',
    ...
    'login.usernameMinLength': 'Le nom d\'utilisateur doit contenir au moins 3 caractères',
