...
const translations = {
  en: {
    ...
    'dispensation.cannotUndo': 'Cannot undo - item has been deactivated or disposed',
  ...
  fr: {
    ...
    'dispensation.cannotUndo': 'Impossible d\'annuler - l\'article a été désactivé ou éliminé',
